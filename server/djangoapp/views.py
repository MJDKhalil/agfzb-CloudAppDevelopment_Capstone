...
from .restapis import get_dealer_reviews_from_cf, get_dealers_by_state, get_dealers_from_cf, get_reviews_max_id, post_request
...
base_url = "https://27336090.eu-gb.apigw.appdomain.cloud/api"
