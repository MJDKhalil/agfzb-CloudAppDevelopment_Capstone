...
def analyze_review_sentiments(dealer_review):
    api_url = "https://api.eu-gb.natural-language-understanding.watson.cloud.ibm.com/instances/d6b6f949-dc92-456c-ab9c-689764b36cec"

    
    # Call get_request with a URL parameter and Watson NLU parameters
    json_result = get_request(api_url,  api_key="FJ2RVwK2X4x6qgiLpbra6g0AXTViS0Gn8hV1HKwOJo79",
                                        version="2021-11-17",
                                        text=dealer_review,
                                        features="sentiment",
